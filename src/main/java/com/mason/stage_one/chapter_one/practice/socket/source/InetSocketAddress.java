...
public class InetSocketAddress extends SocketAddress {
    ...
    private static class InetSocketAddressHolder {
        ...
        public final boolean equals(Object obj) {
            if (obj == null || !(obj instanceof InetSocketAddress.InetSocketAddressHolder))
                return false;
            InetSocketAddress.InetSocketAddressHolder that = (InetSocketAddress.InetSocketAddressHolder) obj;
            boolean sameIP;
            if (addr != null)
    ...
    public InetSocketAddress(InetAddress addr, int port) {
        holder = new InetSocketAddress.InetSocketAddressHolder(
                null,
    ...
    public InetSocketAddress(String hostname, int port) {
        ...
        holder = new InetSocketAddress.InetSocketAddressHolder(host, addr, checkPort(port));
    }

    // private constructor for creating unresolved instances
    private InetSocketAddress(int port, String hostname) {
        holder = new InetSocketAddress.InetSocketAddressHolder(hostname, null, port);
    }
    ...
    private static final ObjectStreamField[] serialPersistentFields = {
            ...
            new ObjectStreamField("addr", java.net.InetAddress.class),
    ...
    private void readObject(ObjectInputStream in)
        ...
        InetSocketAddress.InetSocketAddressHolder h = new InetSocketAddress.InetSocketAddressHolder(oisHostname, oisAddr, oisPort);
