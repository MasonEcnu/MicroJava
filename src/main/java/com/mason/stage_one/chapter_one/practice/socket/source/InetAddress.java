...
class InetAddress implements java.io.Serializable {
     ...
     */
    private static InetAddress.Cache addressCache = new InetAddress.Cache(InetAddress.Cache.Type.Positive);

    private static InetAddress.Cache negativeCache = new InetAddress.Cache(InetAddress.Cache.Type.Negative);
    ...
    static final class Cache {
         ...
         * Create cache
         */
        public Cache(InetAddress.Cache.Type type) {
            this.type = type;
            cache = new LinkedHashMap<>();
        }

        private int getPolicy() {
            if (type == InetAddress.Cache.Type.Positive) {
         ...
         * replaced.
         */
        public InetAddress.Cache put(String host, InetAddress[] addresses) {
            ...
            if (policy != InetAddressCachePolicy.FOREVER) {
                ...
                for (String key : cache.keySet()) {
                    InetAddress.CacheEntry entry = cache.get(key);
            ...
            InetAddress.CacheEntry entry = new InetAddress.CacheEntry(addresses, expiration);
    ...
    private static InetAddress[] getCachedAddresses(String hostname) {
        ...
        synchronized (addressCache) {
            ...
            InetAddress.CacheEntry entry = addressCache.get(hostname);
            if (entry == null) {
    ...
    static {
        try {
            ...
            FIELDS_OFFSET = unsafe.objectFieldOffset(
                    java.net.InetAddress.class.getDeclaredField("holder")
            );
            UNSAFE = unsafe;
