...
class Inet6Address extends InetAddress {
    ...
    private class Inet6AddressHolder {
        ...
        public boolean equals(Object o) {
            if (!(o instanceof Inet6Address.Inet6AddressHolder)) {
                return false;
            }
            Inet6Address.Inet6AddressHolder that = (Inet6Address.Inet6AddressHolder) o;
    ...
    Inet6Address() {
        ...
        holder6 = new Inet6Address.Inet6AddressHolder();
    }
     ...
     * java.net.InetAddress#getByAddress(String, byte[])} except that the IPv6 scope_id is
    ...
    static {
        try {
            ...
            FIELDS_OFFSET = unsafe.objectFieldOffset(
                    java.net.Inet6Address.class.getDeclaredField("holder6"));
            UNSAFE = unsafe;
    ...
    private void readObject(ObjectInputStream s)
        ...
        Inet6Address.Inet6AddressHolder h = new Inet6Address.Inet6AddressHolder(
