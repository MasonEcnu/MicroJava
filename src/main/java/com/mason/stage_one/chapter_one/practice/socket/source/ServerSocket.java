...
public class ServerSocket implements java.io.Closeable {
    ...
    private Object closeLock = new Object();    // 锁
     ...
     * {@link java.net.Socket#getReceiveBufferSize()} after the socket
     ...
     * {@link java.net.Socket#setReceiveBufferSize(int)}. However, if the application
