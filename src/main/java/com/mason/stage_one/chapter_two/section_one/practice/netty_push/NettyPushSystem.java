package com.mason.stage_one.chapter_two.section_one.practice.netty_push;

import com.mason.stage_one.chapter_two.section_one.practice.netty_push.handler.WebSocketServerHandler;
...
public class NettyPushSystem {
    ...
    public static void startTest() {
        ...
        Executors.newScheduledThreadPool(1).scheduleAtFixedRate(() -> {
            try {
                ...
                if (Boolean.parseBoolean(sendMsg)) { // 是否开启发送
    ...
    public static void main(String[] args) {
        System.out.println(System.getProperty("netease.debug"));
    }
}
