package com.mason.stage_one.chapter_two.section_one.practice.netty_push.handler;

import com.mason.stage_one.chapter_two.section_one.practice.netty_push.NettyPushSystem;
...
public class NewConnectHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, FullHttpRequest req) throws Exception {
        ...
        NettyPushSystem.saveConnection(userId, ctx.channel()); // 保存连接
        // 结束
    }
}
