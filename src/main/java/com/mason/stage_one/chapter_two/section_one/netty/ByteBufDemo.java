...
public class ByteBufDemo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("写入一段内容ByteBuf为====>" + buf.toString());
        System.out.println("2.ByteBuf中的内容=======>" + Arrays.toString(buf.array()) + "\n");

        // 3.读取一段内容
        byte b1 = buf.readByte();
        byte b2 = buf.readByte();
        System.out.println("读取bytes为============>" + Arrays.toString(new byte[]{b1, b2}));
        System.out.println("读取一段内容ByteBuf为====>" + buf.toString());
